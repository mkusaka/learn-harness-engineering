...
実際のデータがそれを示しています。整理戦略なしで 12 週間エージェント開発されたプロジェクトでは、次のようになりました。

- 1 週目: ビルド通過率 100%、テスト通過率 100%、新しいセッション開始 5 分
- 4 週目: ビルド 95%、テスト 92%、開始 15 分
- 8 週目: ビルド 82%、テスト 78%、開始 35 分
- 12 週目: ビルド 68%、テスト 61%、開始 60 分以上

整理戦略がある同じプロジェクトでは、次のようになりました。

- 1 週目: 100%、100%、5 分
- 12 週目: 97%、95%、9 分

12 週間後、ビルド通過率の差は 29 パーセントポイント、新しいセッションの開始時間の差は 85% です。これは理論ではなく、観測された差です。
...
**進捗の側面**: 現在の進捗が機械可読な成果物に記録されているか。合格基準付きで完了したサブタスク、現在の状態が記録された進行中だが未完了のサブタスク、まだ開始していないサブタスク。良い進捗記録は、セッション開始時の診断時間を 60-80% 減らします。
...
12 週間エージェントで開発した Electron アプリで、2 つのアプローチを比較します。

**クリーンアップ戦略なし**（対照群）: 12 週目、ビルド通過率 68%、テスト通過率 61%、新しいセッションの開始に 60 分以上、古い成果物 103 個。

**クリーンアップ戦略あり**（実験群）: すべてのセッション終了時に完全なクリーン状態チェック + 週次クリーンアップループ。12 週目、ビルド通過率 97%、テスト通過率 95%、新しいセッションの開始に 9 分、古い成果物 11 個。

12 週目時点で、実験群のビルド通過率は 29 パーセントポイント高く、テスト通過率は 34 ポイント高く、新しいセッション開始時間は 85% 短いです。
